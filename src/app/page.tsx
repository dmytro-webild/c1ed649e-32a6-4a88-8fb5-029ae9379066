...
export default function LandingPage() {
  ...
  <div id="about" data-section="about">
      ...
      bulletPoints={[
        {
          title: "Festangestellte Closer",          description: "Höchste Qualitätsstandards und interne Kontrolle."},
        {
          title: "Externes Profi-Netzwerk",          description: "Skalierbarkeit auf Abruf für kurzfristige Volumina."},
        {
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "High-Ticket Setting",          description: "Wir qualifizieren Leads vor, bis sie closing-bereit sind.",          icon: Zap,
        },
        {
          title: "Closing Operations",          description: "Abschlussorientierte Kommunikation auf Augenhöhe.",          icon: Shield,
        },
        {
          title: "Sales Performance Consulting",          description: "Optimierung Ihrer internen Vertriebskanäle.",          icon: Award,
        },
      ]}
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        {
          id: "m1",          value: "150+",          description: "Erfolgreiche Closings monatlich"},
        {
          id: "m2",          value: "40%",          description: "Steigerung der Conversion-Rate"},
        {
          id: "m3",          value: "24/7",          description: "Vertriebs-Support"},
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        {
          id: "4",          name: "Elena Weber",          date: "20.08.2024",          title: "COO",          quote: "Die externe Unterstützung durch EG war der Wendepunkt für unser Wachstum.",          tag: "Kunde",          avatarSrc: "http://img.b2bpic.net/free-photo/closeup-smiling-senior-business-man-relaxing_1262-2369.jpg",          imageSrc: "http://img.b2bpic.net/free-photo/data-privacy-concept-with-wooden-blocks-with-words-lock-it-side-view_176474-10410.jpg",          imageAlt: "secure sales closing concept"},
        {
          id: "5",          name: "Lukas Meyer",          date: "15.09.2024",          title: "Owner",          quote: "Ein unersetzliches Asset für unsere Skalierung.",          tag: "Kunde",          avatarSrc: "http://img.b2bpic.net/free-photo/friendly-successful-business-lady-wearing-formal-suit-glasses-standing-with-arms-folded-smiling_74855-9932.jpg",          imageSrc: "http://img.b2bpic.net/free-photo/people-working-call-center_23-2149288217.jpg",          imageAlt: "professional sales headset clean"},
      ]}
